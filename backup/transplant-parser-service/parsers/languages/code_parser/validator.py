...
使用方法:
    python -m parsers.languages.code_parser.validator
    
或:
    from parsers.languages.code_parser.validator import validate_all_configs
...
class LanguageConfigValidator:
    ...
    def validate_language_module(self, lang: str, module_path: str) -> ValidationResult:
        ...
        Args:
            lang: 语言名称
            module_path: 模块导入路径 (如 'parsers.languages.code_parser.lang_python')
