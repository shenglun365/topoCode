...
import { compile, tokenize, parse } from '../../../src/lib/topo-animation/compiler';
import { InstructionExecutor } from '../../../src/lib/topo-animation/core/instructions/InstructionExecutor';
  ...
  describe('Instruction Execution', () => {
    it('should execute compiled instructions', () => {
      ...
      if (compileResult.instructions) {
        ...
        const execResult = executor.execute(compileResult.instructions);
