...
export const mockResources = [
  {
    ...
    description: '完整的 Spring Boot + Spring Cloud 微服务体系架构分析，包含 120+ 组件、400+ 依赖关系、8 层社区结构的完整分析报告。',
    category: '微服务',
    thumbnail_url: '',
    download_count: 1280,
    is_free: false,
    pricing_model: 'points',
    points_cost: 30,
    price_cny: 0,
    subscription_tier: '',
  ...
  },
  {
    ...
    description: 'React 18 + TypeScript + Next.js 项目架构可视化分析报告，涵盖组件树、数据流、路由依赖全景图。',
    category: '前端',
    thumbnail_url: '',
    download_count: 856,
    is_free: false,
  ...
  },
  {
    ...
    description: 'K8s 集群部署配置全链路分析，包含 Service Mesh、Ingress、存储卷等核心组件的依赖关系。',
    category: '云原生',
    thumbnail_url: '',
    download_count: 2100,
    is_free: true,
  ...
  {
    id: 4,
    title: 'PyTorch 深度学习模型架构分析',
    description: 'PyTorch 模型定义、训练流程、数据管线的完整架构分析，适合 AI 项目理解和重构。',
    category: 'AI',
    thumbnail_url: '',
    download_count: 1640,
    is_free: true,
  ...
  },
  {
    id: 5,
    title: 'Go 微服务网关架构分析',
    description: '基于 Go 的 API 网关项目架构分析，包含路由、中间件、限流、熔断等组件依赖。',
    category: '微服务',
    thumbnail_url: '',
    download_count: 920,
    is_free: true,
  ...
  },
  {
    id: 6,
    title: 'Vue 3 组件库架构分析',
    description: '大型 Vue 3 组件库的项目结构分析，包含组件分类、混入、指令、插件的完整依赖图。',
    category: '前端',
    thumbnail_url: '',
    download_count: 730,
    is_free: false,
  ...
  {
    id: 7,
    title: 'Unity 游戏客户端架构分析',
    description: 'Unity 3D 游戏项目架构分析，涵盖场景管理、资源加载、UI 系统的模块依赖关系。',
    category: '游戏',
    thumbnail_url: '',
    download_count: 580,
    is_free: false,
  ...
  {
    id: 8,
    title: 'Flutter 跨平台应用架构分析',
    description: 'Flutter + Dart 跨平台应用的项目结构分析，包含状态管理、路由、原生插件的依赖全景。',
    category: '前端',
    thumbnail_url: '',
    download_count: 450,
    is_free: true,
  ...
  {
    id: 9,
    title: 'Node.js 微服务架构分析',
    description: 'Node.js + Express 微服务项目架构分析，包含服务注册、配置中心、消息队列的完整链路。',
    category: '微服务',
    thumbnail_url: '',
    download_count: 1100,
    is_free: false,
  ...
  {
    id: 10,
    title: 'TensorFlow 模型部署管线分析',
    description: 'TensorFlow Serving + Docker + Kubernetes 的模型部署全链路架构分析报告。',
    category: 'AI',
    thumbnail_url: '',
    download_count: 870,
    is_free: true,
