...
class AgentTaskState:
    ...
    def to_dict(self) -> dict:
        ...
        d = {
            ...
            "total_files": self.progress.total_files if self.progress else 0,
            "total_comps": self.progress.total_comps if self.progress else 0,
            "done_files": self.progress.done_files if self.progress else 0,
            "done_comps": self.progress.done_comps if self.progress else 0,
            "error": self.error,
